...
def get_random_adverb() -> str:
    with open(r"Random Sentences Generator\text\adverbs.txt", "r") as txt_file:
...
def get_random_city() -> str:
    with open(r"Random Sentences Generator\text\cities.txt", "r") as txt_file:
        line = txt_file.readlines()
...
def get_random_detail() -> str:
    with open(r"Random Sentences Generator\text\details.txt", "r") as txt_file:
        line = txt_file.readlines()
...
def get_random_verb() -> str:
    with open(r"Random Sentences Generator\text\verbs.txt", "r") as txt_file:
        line = txt_file.readlines()
